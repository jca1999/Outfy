...
- Las operaciones privilegiadas de base de datos usan un cliente Supabase separado con `SUPABASE_URL` y `SUPABASE_SECRET_KEY`; la clave secreta nunca debe usar prefijo `VITE_` ni entrar en el frontend.
