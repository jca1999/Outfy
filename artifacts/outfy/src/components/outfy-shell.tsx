        ...
        <header className="sticky top-0 z-20 border-b border-border/70 bg-background/90 px-4 py-4 backdrop-blur-xl sm:px-8">
          <div className="mx-auto flex max-w-[1240px] items-center justify-between gap-3">
            ...
            <div className="ml-auto flex items-center gap-2">
              <button type="button" onClick={onCreateActivity} className="outfy-primary-action hidden items-center gap-1.5 rounded-full bg-primary px-4 py-2.5 text-xs font-bold text-primary-foreground transition sm:flex" data-testid="button-create-activity"><Plus className="h-3.5 w-3.5" />Crear plan</button>
